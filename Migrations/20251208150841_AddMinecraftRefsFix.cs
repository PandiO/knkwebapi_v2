...
{
    /// <inheritdoc />
    public partial class AddMinecraftRefsFix : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
                    ...
                    SELECT IF(
                        EXISTS (
                            ...
                            WHERE TABLE_SCHEMA = DATABASE()
                              ...
                              AND COLUMN_NAME = 'IconMaterialRefId'
                        ),
                        'ALTER TABLE `categories` DROP COLUMN `IconMaterialRefId`;',
                        'SELECT 1;'
                    )
                );
            ...
            ");
            migrationBuilder.Sql("DROP TABLE IF EXISTS `minecraftmaterialrefs`;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS `minecraftblockrefs`;");
